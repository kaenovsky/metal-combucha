    ...
    return (
      <Slider {...settings} className='slider-wrapper'>
        <div className='spotify-episodes'>
            <iframe src="https://open.spotify.com/embed-podcast/episode/3bbYxUk7czx1nnywAUYkMt"
                title="episode"
                height="232" 
                frameborder="0" 
        ...
        <div className='spotify-episodes'>
            <iframe src="https://open.spotify.com/embed-podcast/episode/0LPZayZYdzmwo6VZxzK4tV"
                title="episode"
                height="232" 
                frameborder="0" 
                allowtransparency="true" 
        ...
        <div className='spotify-episodes'>
            <iframe src="https://open.spotify.com/embed-podcast/episode/2M3HEnbLd2ffZyVaFp8XLY"
                title="episode"
                height="232" 
                frameborder="0" 
                allowtransparency="true" 
